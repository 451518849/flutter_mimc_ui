...
import 'package:flutter_mimc_ui/view/gallery/photo.dart';
      ...
      return Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              onTap: () => _pushToFullImage(context, widget.message.secondaryPayload.meta.url),
              child: Container(
                height: 200,
                width: 200,
                margin: const EdgeInsets.only(bottom: 10, left: 4),
                child: Image(
                  image: widget.message.secondaryPayload.meta.url.contains("http")
                      ? NetworkImage(widget.message.secondaryPayload.meta.url + ImageSize)
                      : FileImage(File(widget.message.secondaryPayload.meta.url)),
                  fit: BoxFit.cover,
                ),
              ),
            ),
