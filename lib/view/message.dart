...
import 'package:flutter_mimc_ui/view/message/text.dart';
...
class _ImMessageItemViewState extends State<ImMessageItemView> {
  ...
  Widget _messageView(BuildContext context) {
    if (widget.message.secondaryPayload.bizType == ImMessageType.text) {
      return TextMessage(
    ...
    } else if (widget.message.secondaryPayload.bizType == ImMessageType.image) {
      return ImageMessage(
        message: widget.message,
        messageAlign: widget.messageAlign,
        color: widget.color,
    ...
    } else if (widget.message.secondaryPayload.bizType == ImMessageType.audio) {
      return AudioMessage(
        message: widget.message,
        messageAlign: widget.messageAlign,
        color: widget.color,
    ...
    } else if (widget.message.secondaryPayload.bizType == ImMessageType.video) {
      return VideoMessage(
        message: widget.message,
        messageAlign: widget.messageAlign,
        color: widget.color,
